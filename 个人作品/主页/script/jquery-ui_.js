...
$.extend(Datepicker.prototype, {
	...
	_generateHTML: function(inst) {
		...
		prev = (this._canAdjustMonth(inst, -1, drawYear, drawMonth) ?
			"<a id='c_prev' class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click'" +
		...
		next = (this._canAdjustMonth(inst, +1, drawYear, drawMonth) ?
			"<a id='c_next' class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click'" +
