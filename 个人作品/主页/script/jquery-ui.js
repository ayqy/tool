...
$.extend(Datepicker.prototype, {
	...
	_generateHTML: function(inst) {
		...
		prev = (this._canAdjustMonth(inst, -1, drawYear, drawMonth) ?
			"<a id='c_prev' class='ui-datepicker-prev' data-handler='prev' data-event='click'" +
			" title='" + prevText + "'><span style='font-family: 黑体; cursor: pointer;'>&lt;&lt;</span></a>" :
		...
		next = (this._canAdjustMonth(inst, +1, drawYear, drawMonth) ?
			"<a id='c_next' class='ui-datepicker-next' data-handler='next' data-event='click'" +
			" title='" + nextText + "'><span style='font-family: 黑体; cursor: pointer;'>&gt;&gt;</span></a>" :
